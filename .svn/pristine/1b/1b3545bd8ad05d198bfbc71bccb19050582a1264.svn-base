...
<div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">管理中心<b>></b><strong>添加单页面</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="/companyweb/page" class="actionBtn">单页面列表</a>添加单页面</h3>
    <form id="customForm">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td align="right"><font size="4">标题</font></td>
       <td>
      ...
      <tr>
       ...
       <td>
        <input type="text" name="other" value="" size="90" class="inpMain" />
       </td>
      </tr>
      <tr>
...
//初始化类目选择和图片上传器
	...
	function submitForm(){
		...
		$.post("/companyweb/custom/save",$("#customForm").serialize(),function(data){
			if(data.status == 200){
