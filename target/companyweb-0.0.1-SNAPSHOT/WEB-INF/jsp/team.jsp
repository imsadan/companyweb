...
<div id="menu">
 ...
 <div id="dcMain">
 <!-- 当前位置 -->
<div id="urHere">管理中心<b>></b><strong>信普团队</strong></div>   
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="/companyweb/addteams" class="actionBtn">添加成员</a>团队</h3>
   <div class="page" id="connteam">
   </div>
</div>
</div>
</div>
...
<script type="text/javascript">
    ...
    $.ajax({
               ...
               for(var i=0;i<result.length;i++){
                  ...
                  table+="<dt style='margin-top:50px;'><b><font color='#000' size='3'>"+result[i].name+"</font></b></dt>";
    ...
    //id查找当年修改的对象
     function click_pop(obj){
    	 ...
    	 $.ajax({
             ...
             success:function(data){
            	 ...
            	 for(var i=0;i<1;i++){
            		    tab+="<tr>";
            		    tab+="<td><font size='5'>成员编号:</font></td>";
            		    tab+="<td><input class='easyui-textbox' type='text' name='id' value='"+s.id+"' style='width:80px;' readonly='readonly' /></td>";
            		    tab+="</tr>";
            		    tab+="<tr>";
            		    tab+="<td><font size='5'>姓名:</font></td>";
            		    tab+="<td>";
            		    	tab+="<input class='easyui-textbox' type='text' name='name' value='"+s.name+"'  readonly='readonly' style='width: 180px;' readonly='readonly'/>";
            		    tab+="</td>";
            		    tab+="</tr>";            		    
            	        tab+="<tr>";
            	        tab+="<td><font size='5'>照片:</font></td>";
            	        tab+="<td>";
            	        	tab+="<a href='javascript:void(0)' class='easyui-linkbutton picFileUpload'>上传照片</a>";
            		    ...
            		    tab+="<td>";
            		      tab+="<input class='easyui-textbox' type='text' name='intro' value='"+s.intro+"' style='width:250px;height:50px;'/>";
            		    tab+="</td>";
            		    tab+="</tr>";	 
            	 }
            	 $("#conntab").append(tab);
 	...
 	function submitForm(){
 		...
 		$.post("/companyweb/team/update",$("#customForm").serialize(),function(data){
 			if(data.status == 200){
 				$.messager.alert('提示','更新个人信息成功!',undefined,function(){
         			window.location.href="http://localhost:8080/companyweb/team";
         		 });
 			}else{
